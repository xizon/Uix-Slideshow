	...
	class Uix_Slideshow_Custom_Metaboxes {
		...
		*/
		...
		public static function admin_body_class( $classes ) {
			return "$classes uix-slideshow-cmb__bodyclass";
		}
...
//
//            $plugins['code'] = UixSlideshow::plug_directory() .'includes/admin/uix-custom-metaboxes/editor/plugins/syntax-highlight-code/prism.js';
//            return $plugins;
//        }
...
//
		...
		public static function backstage_scripts() {
				 ...
				 ) 
			  {
					...
					wp_enqueue_style( 'uix-slideshow-custom-metaboxes', UixSlideshow::plug_directory() .'includes/admin/uix-custom-metaboxes/css/uix-custom-metaboxes.min.css', false, self::$ver, 'all' );
					//RTL		
					if ( is_rtl() ) {
						wp_enqueue_style( 'uix-slideshow-custom-metaboxes-rtl', UixSlideshow::plug_directory() .'includes/admin/uix-custom-metaboxes/css/uix-custom-metaboxes.min-rtl.css', false, self::$ver, 'all' );
					} 
				  
				  
					wp_enqueue_script( 'uix-slideshow-custom-metaboxes', UixSlideshow::plug_directory() .'includes/admin/uix-custom-metaboxes/js/uix-custom-metaboxes.min.js', array( 'jquery' ), self::$ver, true );
                  
                  
					wp_localize_script( 'uix-slideshow-custom-metaboxes',  'uix_slideshow_custom_metaboxes_lang', array( 
						'ed_lang'                 => get_locale(),
						'ed_url'                  => UixSlideshow::plug_directory() .'includes/admin/uix-custom-metaboxes/',
						'ed_media_title'          => __( 'Select Files', 'uix-slideshow' ),
						'ed_media_text'           => __( 'Insert', 'uix-slideshow' ),				
						'ed_image'                => __( 'Insert Image', 'uix-slideshow' ),
						'ed_unlink_title'         => __( 'Remove link', 'uix-slideshow' ),
						'ed_link_title'           => __( 'Insert/Edit link', 'uix-slideshow' ),
						'ed_link_field_url'       => __( 'URL', 'uix-slideshow' ),
						'ed_link_field_text'      => __( 'Link Text', 'uix-slideshow' ),
						'ed_link_field_win'       => __( 'Open link in a new tab', 'uix-slideshow' ),
						'ed_hcode_title'          => __( 'Syntax Highlight Code', 'uix-slideshow' ),
						'ed_hcode_field_label'    => __( 'Language', 'uix-slideshow' ),
                        'select_empty_text'       => __( '-', 'uix-slideshow' ),
                        'delete_confirm_text'     => __( 'Are you sure you want to delete?', 'uix-slideshow' ),
					...
					wp_enqueue_script( 'wp-color-picker-alpha', UixSlideshow::plug_directory() .'includes/admin/uix-custom-metaboxes/js/' . $wp_color_picker_alpha_uri_name, array( 'wp-color-picker', 'uix-slideshow-custom-metaboxes' ), '2.1.2', true );
		...
		*/
		public static function register_meta_boxes( $post, $metabox ) {
			...
			?>
			<!-- Begin Fields -->
			<div class="uix-slideshow-cmb__wrapper">
				<table class="form-table uix-slideshow-cmb">
		...
		?>
			...
			<tr>
				<th class="uix-slideshow-cmb__title">
					...
					<?php if ( !empty ( $desc ) ) { ?>
					    <p class="uix-slideshow-cmb__title_desc"><?php echo UixSlideshow::kses( $desc ); ?></p>
					<?php } ?>
				</th>
				<td>
            <?php endif; ?>
            ...
            <?php endif; ?>
					   ...
					   <textarea placeholder="<?php echo esc_attr( $placeholder ); ?>" rows="<?php echo absint( $rows ); ?>" cols="40" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>"><?php echo esc_textarea( $default ); ?></textarea>
						<?php if ( !empty ( $desc_primary ) ) { ?>
							<p class="uix-slideshow-cmb__description"><?php echo UixSlideshow::kses( $desc_primary ); ?></p>
						<?php } ?>
		...
		*/
		...
		?>
            ...
            <?php endif; ?>
					   ...
					   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-slideshow-cmb__normal-text" value="<?php echo esc_attr( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
						<?php if ( !empty ( $desc_primary ) ) { ?>
							<p class="uix-slideshow-cmb__description"><?php echo UixSlideshow::kses( $desc_primary ); ?></p>
						<?php } ?>
		...
		*/
		...
		?>
            ...
            <?php endif; ?>    
					   ...
					   <input data-format="<?php echo esc_attr( $format ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-slideshow-cmb__short-text uix-slideshow-cmb__date-selector" value="<?php echo esc_attr( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
						<?php if ( !empty ( $desc_primary ) ) { ?>
							<span class="uix-slideshow-cmb__description"><?php echo UixSlideshow::kses( $desc_primary ); ?></span>
						<?php } ?>
		...
		*/
		...
		?>
            ...
            <?php endif; ?>      
					   ...
					   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-slideshow-cmb__normal-text" value="<?php echo esc_url( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
						<?php if ( !empty ( $desc_primary ) ) { ?>
							<p class="uix-slideshow-cmb__description"><?php echo UixSlideshow::kses( $desc_primary ); ?></p>
						<?php } ?>
		...
		*/
		...
		?>
            ...
            <?php endif; ?>    
					   ...
					   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-slideshow-cmb__short-text" value="<?php echo ( empty( $default ) ) ? 0 : floatval( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
						<?php 
		...
		*/
		...
		?>
            ...
            <?php endif; ?>     
					   ...
					   <input placeholder="<?php echo esc_attr( $placeholder ); ?>" type="text" class="uix-slideshow-cmb__color-selector" value="<?php echo esc_attr( $default ); ?>" name="<?php echo esc_attr( $id ); ?>" id="<?php echo esc_attr( $id ); ?>">
						<?php if ( !empty ( $desc_primary ) ) { ?>
							<p class="uix-slideshow-cmb__description"><?php echo UixSlideshow::kses( $desc_primary ); ?></p>
						<?php } ?>
		...
		*/
		...
		?>
            ...
            <?php endif; ?>     
					  ...
					  <div class="radio uix-slideshow-cmb__radio-selector" data-target-id="<?php echo esc_attr( $id ); ?>">
						...
						if ( is_array ( $options )  && isset( $options[ 'value' ] ) ) {
							...
							foreach ( $options[ 'value' ] as $key => $value  ) {
								...
								<?php if ( $radio_type == 'normal' ) { ?>
									<label data-value="<?php echo esc_attr( $key ); ?>" data-toggle-id="<?php echo esc_attr( $toggle_id ); ?>" class="<?php if ( $br ) { echo 'uix-slideshow-cmb__label'; } else { echo ''; }; ?> uix-slideshow-cmb__radio-text uix-slideshow-cmb__toggle-selector <?php if ( $default == esc_attr( $key ) || empty( $default ) ) { echo 'active'; } else { echo ''; }; ?>"><input type="radio" name="<?php echo esc_attr( $id ); ?>_r" value="<?php echo esc_attr( $key ); ?>" <?php echo esc_html( $checked ); ?>/><?php echo UixSlideshow::kses( $value ); ?></label>
								<?php } ?>
								...
								<?php if ( $radio_type == 'switch' ) { ?>
									<label data-value="<?php echo esc_attr( $key ); ?>" data-switch-ids="<?php echo esc_attr( $toggle_switch_id ); ?>" class="<?php if ( $br ) { echo 'uix-slideshow-cmb__label'; } else { echo ''; }; ?> uix-slideshow-cmb__radio-text uix-slideshow-cmb__switch-radios <?php if ( $default == esc_attr( $key ) || empty( $default ) ) { echo 'active'; } else { echo ''; }; ?>"><input type="radio" name="<?php echo esc_attr( $id ); ?>_r" value="<?php echo esc_attr( $key ); ?>" <?php echo esc_html( $checked ); ?>/><?php echo UixSlideshow::kses( $value ); ?></label>
								<?php } ?>	
							...
							foreach ( $options[ 'value' ] as $key => $value  ) {
									 ...
									 isset( $options[ 'toggle' ][ $key ] ) ) 
								{
                                    ...
                                    //---
                                    $toggle_ipt_title         = ( isset( $v[ 'title' ] ) ) ? $v[ 'title' ] : esc_html__( 'Field Title', 'uix-slideshow' );
								...
								<?php if ( !empty( $toggle_id ) ) { ?>
                                    ...
                                    <div class="uix-slideshow-cmb__toggle-target" id="<?php echo esc_attr( $toggle_id ); ?>" style="display:none;" >
                                        <?php
                                        //------
		...
		*/
		public static function addfield_custom_attrs( $id, $title, $desc, $default, $options = '', $placeholder = '', $desc_primary = '', $enable_table = false ) {
			...
			$temp = '
				<div class="uix-slideshow-cmb__text--div">
					<label class="uix-slideshow-cmb__text--p">
						<p class="uix-slideshow-cmb__description">
							'.esc_html( $label_title ).'
						</p>
						<input class="uix-slideshow-cmb__text--small" name="'.esc_attr( $id ).'_attrs_title[]" value="{name}"><span class="important2">*</span>&nbsp;&nbsp;
					</label>
		...
		?>
			...
			<tr>
             ...
             <?php endif; ?> 
					...
					<!-- Begin Fields -->
					<div class="uix-slideshow-cmb__wrapper uix-slideshow-cmb__custom-attributes-field <?php echo esc_attr( $one_column? 'uix-slideshow-cmb__wrapper--one-column' : '' ); ?>" data-append-id="<?php echo esc_attr( $id ); ?>_append" data-tmpl='<?php echo esc_attr( $temp_attr ); ?>'>
		...
		* @print: 
            ...
            $_data = json_decode( get_post_meta( get_the_ID(), 'uix_slideshow_themeplugin_multicontent', true ), true );
		...
		*/
		...
		public static function addfield_multi_content( $id, $title, $desc, $default, $options = '', $placeholder = '', $desc_primary = '', $enable_table = false ) {
			...
			$label_title          = esc_html__( 'Title', 'uix-slideshow' );
			$label_value          = esc_html__( 'Value', 'uix-slideshow' );
            $label_subtitle       = esc_html__( 'Subtitle', 'uix-slideshow' );
            $label_id             = esc_html__( 'ID', 'uix-slideshow' );
            $label_level          = esc_html__( 'Level', 'uix-slideshow' );
            ...
            //editor options
            $editor_toolbar = 'formatselect fontselect forecolor backcolor bold italic underline strikethrough bullist numlist blockquote code alignleft aligncenter alignright uix_slideshow_link uix_slideshow_unlink | removeformat outdent indent superscript subscript hr uix_slideshow_image uix_slideshow_highlightcode media customCode fullscreen';
            $editor_toolbar_teeny = 'formatselect forecolor backcolor bold italic underline strikethrough alignleft aligncenter alignright uix_slideshow_link uix_slideshow_unlink removeformat customCode';
            ...
            $level_res = '<select class="uix-slideshow-cmb__text--fullwidth uix-slideshow-cmb__text--div--toggle__sel">';
            $level_res.= '<option value="">'.esc_html__( '-', 'uix-slideshow' ).'</option>';
...
//                        }//endif $level_2_content
			...
			$temp = '
				...
				<div class="uix-slideshow-cmb__text--div uix-slideshow-cmb__text--div--toggle {childstyle}">
                   ...
                   <a href="javascript:void(0);" class="uix-slideshow-cmb__custom-attributes-field__removebtn" title="'.esc_attr( $label_upbtn_remove ).'"><svg aria-hidden="true" role="img" focusable="false" class="dashicon dashicons-trash" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path d="M12 4h3c.6 0 1 .4 1 1v1H3V5c0-.6.5-1 1-1h3c.2-1.1 1.3-2 2.5-2s2.3.9 2.5 2zM8 4h3c-.2-.6-.9-1-1.5-1S8.2 3.4 8 4zM4 7h11l-.9 10.1c0 .5-.5.9-1 .9H5.9c-.5 0-.9-.4-1-.9L4 7z"></path></svg></a>
                    ...
                    <div class="uix-slideshow-cmb__text--div--toggle__div">
                    
                        
                        <label class="uix-slideshow-cmb__text--row">
                            <p class="uix-slideshow-cmb__description">
                                '.esc_html( $label_title ).'
                            </p>
                            <input class="uix-slideshow-cmb__text--fullwidth uix-slideshow-cmb__text--div--toggle__title" name="'.esc_attr( $id ).'_attrs_title[]" value="{name}"><span class="important2">*</span>
                        </label>
                        ...
                        <label class="uix-slideshow-cmb__text--row">
                            ...
                            <input class="uix-slideshow-cmb__text--fullwidth uix-slideshow-cmb__text--div--toggle__id" name="'.esc_attr( $id ).'_attrs_id[]" value="{id}">
                        </label>
                        ...
                        <label class="uix-slideshow-cmb__text--row">
                            ...
                            <input type="hidden" class="uix-slideshow-cmb__text--div--toggle__toggleSelect" name="'.esc_attr( $id ).'_attrs_level[]" value="{level}">
                            '.$level_res.'
                        </label>    
                        ...
                        <label class="uix-slideshow-cmb__text--row">
                            ...
                            <input class="uix-slideshow-cmb__text--fullwidth" name="'.esc_attr( $id ).'_attrs_classname[]" value="{classname}">
                        </label>   
                        ...
                        <label class="uix-slideshow-cmb__text--row">
                            ...
                            <div class="uix-slideshow-cmb__mce-editor uix-slideshow-cmb__mce-editor--multi" aria-init="0">
			...
			$temp_attr = str_replace( '{name}', esc_html__( 'Untitled', 'uix-slideshow' ), 
						 str_replace( '{value}', '',  
                         str_replace( '{level}', '',
                                                ...
                                                if ( is_array( $level_2_content ) && sizeof( $level_2_content ) > 0 ) {
                                                    ...
                                                    foreach( $level_2_content as $index => $value ) {
                                                        echo str_replace( '{name}', esc_attr( self::parse_json_data_from_editor( $value[ 'name' ] ) ), 
                                                                     ...
                                                                     str_replace( '{subtitle}', esc_textarea( self::parse_json_data_from_editor( $value[ 'subtitle' ] ) ),
                                                                     str_replace( '{classname}', esc_attr( self::parse_json_data_from_editor( $value[ 'classname' ] ) ), 
                                                                     str_replace( '{childstyle}', 'uix-slideshow-cmb__text--div--toggle--child',        
                                                                     $temp 
                                                                    )))))));        
                                                    }
		...
		* @print: 
            ...
            $_data = json_decode( get_post_meta( get_the_ID(), 'uix_slideshow_themeplugin_multiworks', true ), true );
            ...
            if ( is_array( $_data ) && sizeof( $_data ) > 1 ) {
                ...
                foreach( $_data as $index => $value ) {
                    if ( is_array( $value ) && sizeof( $value ) > 0 ) {
                        ...
                        if ( array_key_exists( 'lightbox', $value ) ) {
                            $lightbox_enable = esc_attr( Uix_Slideshow_Custom_Metaboxes::parse_json_data_from_editor( $value[ 'lightbox' ] ) );
                            break;
                ...
                foreach( $_data as $index => $value ) {
                    ...
                    ?>
                        <div class="uix-slideshow-portfolio-type-<?php echo esc_attr( Uix_Slideshow_Custom_Metaboxes::parse_json_data_from_editor( $value[ 'type' ] ) ); ?>">

                            <?php
                            $img_url = Uix_Slideshow_Custom_Metaboxes::parse_json_data_from_editor( $value[ 'filePath' ] );
		...
		*/
		...
		public static function addfield_multi_portfolio( $id, $title, $desc, $default, $options = '', $placeholder = '', $desc_primary = '', $enable_table = false ) {
            ...
            //type
            //Do not use "name" on <select>, because js may cause data to be empty and cannot be saved.
            $type_res = '<select class="uix-slideshow-cmb__text--fullwidth uix-slideshow-cmb__text--div--toggle__simple-sel">';
				...
				<div class="uix-slideshow-cmb__text--div uix-slideshow-cmb__text--div--toggle uix-slideshow-cmb__text--div--toggle--sortable">
                   ...
                   <a href="javascript:void(0);" class="uix-slideshow-cmb__custom-attributes-field__removebtn" title="'.esc_attr( $label_upbtn_remove ).'"><svg aria-hidden="true" role="img" focusable="false" class="dashicon dashicons-trash" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><path d="M12 4h3c.6 0 1 .4 1 1v1H3V5c0-.6.5-1 1-1h3c.2-1.1 1.3-2 2.5-2s2.3.9 2.5 2zM8 4h3c-.2-.6-.9-1-1.5-1S8.2 3.4 8 4zM4 7h11l-.9 10.1c0 .5-.5.9-1 .9H5.9c-.5 0-.9-.4-1-.9L4 7z"></path></svg></a>
                    ...
                    <div class="uix-slideshow-cmb__text--div--toggle__div">
                        ...
                        <label class="uix-slideshow-cmb__text--row" style="display:none;">
                        ...
                        <label class="uix-slideshow-cmb__text--row" data-type="file">
                            <p class="uix-slideshow-cmb__description">
                                '.esc_html( $label_file ).'
                            </p>
                            <div class="uix-slideshow-cmb__upload-wrapper">
                        ...
                        <label class="uix-slideshow-cmb__text--row" data-type="html">
                            <p class="uix-slideshow-cmb__description">
                                '.esc_html( $label_html ).'
                            </p>
            ...
            <?php endif; ?>	
					...
					<div class="uix-slideshow-cmb__wrapper uix-slideshow-cmb__custom-attributes-field <?php echo esc_attr( $one_column? 'uix-slideshow-cmb__wrapper--one-column' : '' ); ?>" data-append-id="<?php echo esc_attr( $id ); ?>_append" data-tmpl='<?php echo esc_attr( $temp_attr ); ?>'>
                        ...
                        <?php endif; ?>	
                                    ...
                                    <div class="uix-slideshow-cmb__checkbox-selector" <?php echo ( empty( $label_lightbox ) || $label_lightbox === false ? 'style="display: none;"' : '' ); ?>>
                                        ...
                                        <label>
                                            ...
                                            <?php if ( !empty ( $label_lightbox ) ) { ?>
                                                <span class="uix-slideshow-cmb__description"><?php echo esc_html( $label_lightbox ); ?></span>
                                            <?php } ?>
                                    ...
                                    <div class="uix-slideshow-cmb__custom-attributes-field__addbtn__wrapper uix-slideshow-cmb__custom-attributes-field__addbtn__wrapper--multi">
                                         <a href="javascript:void(0);" class="uix-slideshow-cmb__custom-attributes-field__addbtn uix-slideshow-cmb__custom-attributes-field__addbtn--multi" data-type="file">
				...
				L384,298.667H128z"/></g></svg>
                                         ...
                                         <a href="javascript:void(0);" class="uix-slideshow-cmb__custom-attributes-field__addbtn uix-slideshow-cmb__custom-attributes-field__addbtn--multi" data-type="html">
