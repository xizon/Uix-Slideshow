 ...
 */
 const UixSlideshowCustomMetaboxes = function( obj ) {
	...
	const UixSlideshowCustomMetaboxesConstructor = function( obj ) {
		this.init = obj;
	};

	UixSlideshowCustomMetaboxesConstructor.prototype = {
		...
		getInstance: function() {
			...
			jQuery( document ).ready( function() {
				...
				UixSlideshowCustomMetaboxesConstructor.prototype.radio.call( this, '.uix-slideshow-cmb__radio-selector' );
				UixSlideshowCustomMetaboxesConstructor.prototype.toggle.call( this, '.uix-slideshow-cmb__toggle-selector' );
				UixSlideshowCustomMetaboxesConstructor.prototype.color.call( this, '.uix-slideshow-cmb__color-selector' );
				UixSlideshowCustomMetaboxesConstructor.prototype.tabs.call( this, '.uix-slideshow-cmb__tabsgroup-selector' );
				UixSlideshowCustomMetaboxesConstructor.prototype.date.call( this, '.uix-slideshow-cmb__date-selector' );
				UixSlideshowCustomMetaboxesConstructor.prototype.customAttrs.call( this, '.uix-slideshow-cmb__custom-attributes-field', 100 );
					...
					const switchFun = function( curSel ) {
						...
						$this.find( '[data-switch-ids]' ).each( function()  {
							const _targetID      = jQuery( this ).attr( 'data-switch-ids' ),
								_targetIDs     = UixSlideshowGetRealIds( _targetID  );
						...
						//
						if ( allSwitchIds != '' ) {
							jQuery( UixSlideshowGetRealIds( allSwitchIds  ) ).closest( 'tr' ).hide();
						}
						...
						const switchTargetID = curSel.attr( 'data-switch-ids' ),
							switchTargetIDs = UixSlideshowGetRealIds( switchTargetID  );
				...
				jQuery( selector ).each(function(){
                    ...
                    if ( $this.hasClass( 'active' ) ) {
                        if ( tid != '' || typeof tid !== typeof undefined ) {
                            $this.closest( '[data-target-id]' ).find( '.uix-slideshow-cmb__toggle-target' ).hide();
                            jQuery( '#' + tid ).show();
                        }
                    }
		...
		toggleSelect: function() {
			...
			jQuery( document ).ready( function() {
                ...
                jQuery( '.uix-slideshow-cmb__wrapper.uix-slideshow-cmb__custom-attributes-field.uix-slideshow-cmb__custom-attributes-field--customlevel' ).UixSlideshowToggleSelectInit();
				
				//Initialize Select of Toggle
                jQuery( '.uix-slideshow-cmb__text--div--toggle__simple-sel' ).UixSlideshowToggleSimpleSelectInit({ type: 'file'});
		...
		upload: function() {
			...
			jQuery( document ).ready( function() {
                ...
                const selector = '.uix-slideshow-cmb__upload-target';
				...
				jQuery( selector ).each( function()  {
                    ...
                    $this.next( _closebtn ).off( 'click.UixUploadClose' ).on( 'click.UixUploadClose', function( event ){
                        ...
                        jQuery( this ).hide();
                        jQuery( this ).closest( '.uix-slideshow-cmb__upload-wrapper' ).find( selector ).show();
                        jQuery( this ).closest( '.uix-slideshow-cmb__upload-wrapper' ).find( selector ).attr( 'aria-disabled', true );
                    ...
                    $this.off( 'click.UixUpload' ).on( 'click.UixUpload', function( e ) {
                        ...
                        if ( $thisClick.attr( 'aria-disabled' ) == 'true' ) {
                            ...
                            upload_frame = wp.media( {
								title: uix_slideshow_custom_metaboxes_lang.ed_media_title,
								button: {
								text: uix_slideshow_custom_metaboxes_lang.ed_media_text,
                            },
                                multiple: false
                            } );
		...
		customAttrs: function( selector, max ) {
			...
			jQuery( document ).ready( function() {
				...
				jQuery( selector ).each(function(){
					...
					const $this     = jQuery( this ),
						$addButton  = $this.find( '.uix-slideshow-cmb__custom-attributes-field__addbtn' ), //The add button selector ID or class
					...
					//Prevent duplicate function assigned
					$addButton.off( 'click.UixSlideshowCustomMetaboxes_customAttrs_add' ).on( 'click.UixSlideshowCustomMetaboxes_customAttrs_add', function( e ) {
						e.preventDefault();
						...
						if( x < maxField ){ 
                            ...
                            const uuid = UixSlideshowGUIDCreate();
                            ...
                            jQuery.when( jQuery( wrapperID ).length > 0 ).then( function() {
                                ...
                                if ( typeof $btn.data( 'type' ) !== typeof undefined ) {
									...
									//Initialize Select of Toggle
                                   jQuery( '.uix-slideshow-cmb__text--div--toggle__simple-sel' ).UixSlideshowToggleSimpleSelectInit({ type: $btn.data( 'type' ) });
                                ...
                                //Initialize Uploader
                                UixSlideshowCustomMetaboxesInit.upload();
						...
						//Fold all items
						jQuery( '.uix-slideshow-cmb__text--div--toggle__trigger' ).parent().removeClass( 'active' );
						jQuery( '.uix-slideshow-cmb__text--div--toggle__trigger' ).removeClass( 'active' );
					...
					//Prevent duplicate function assigned
					jQuery( '.uix-slideshow-cmb__custom-attributes-field__removebtn' ).off( 'click.UixSlideshowCustomMetaboxes_customAttrs_remove' );
					jQuery( document ).on( 'click.UixSlideshowCustomMetaboxes_customAttrs_remove', '.uix-slideshow-cmb__custom-attributes-field__removebtn', function( e ) {
						e.preventDefault();
                        
                        //fixed click events firing multiple times
                        e.stopImmediatePropagation();
                        
                        if ( confirm( uix_slideshow_custom_metaboxes_lang.delete_confirm_text ) ) {
                            const $li = jQuery( this ).closest( '.uix-slideshow-cmb__text--div' );

                            if ( jQuery( '.uix-slideshow-cmb__custom-attributes-field .uix-slideshow-cmb__text--div' ).length == 1 ) {
                                $li.find( 'input' ).val( '' );
                                $li.hide();
                            } else {
                                $li.remove();
	...
	return new UixSlideshowCustomMetaboxesConstructor( obj );
};
...
//--------
const UixSlideshowCustomMetaboxesInit = new UixSlideshowCustomMetaboxes();
UixSlideshowCustomMetaboxesInit.getInstance(); 
...
"use strict";
    $( function() {
		...
		if ( typeof(tinymce) !== 'undefined' ) {
			...
			tinymce.PluginManager.add('uix_slideshow_cmb_customcode', function(editor) {
				function showDialog() {
					const win = editor.windowManager.open({
						title: uix_slideshow_custom_metaboxes_lang.ed_sourcecode_title,
						body: {
							type: 'textbox',
							name: 'uix_slideshow_cmb_customcode',
							multiline: true,
						...
						onSubmit: function(e) {
							...
							if(editor.readonly != true){
								editor.undoManager.transact(function() {
									editor.setContent(e.data.uix_slideshow_cmb_customcode);
								});
							}
					...
					win.find('#uix_slideshow_cmb_customcode').value(editor.getContent({source_view: true}));

					//disable source code editing while in readonly mode
					if(editor.readonly){
						const id = win.find('#uix_slideshow_cmb_customcode')[0]._id;
						$(win.find('#uix_slideshow_cmb_customcode')[0]._elmCache[id]).prop('readonly', true);
					}
				...
				editor.addButton('uix_slideshow_cmb_customcode', {
					icon: 'code',
					tooltip: uix_slideshow_custom_metaboxes_lang.ed_sourcecode_title,
					onclick: showDialog,
					classes:'uix_slideshow_cmb_customcode'
				});

				editor.addMenuItem('uix_slideshow_cmb_customcode', {
					icon: 'code',
					text: uix_slideshow_custom_metaboxes_lang.ed_sourcecode_title,
					context: 'tools',
					onclick: showDialog
				});
			});	
...
( function ( $ ) {
	'use strict';
    $.fn.UixSlideshowMCEEditor = function( options ) {
        ...
        this.each( function() {
            ...
            if( typeof id !== typeof undefined ) {
				...
				tinymce.init({
					...
					plugins: 'textcolor image media hr uix_slideshow_cmb_customcode colorpicker lists fullscreen',		
				    toolbar: toolbar,
					setup:function( ed ) {
					   ...
					   ed.on( 'change', function(e) {
						   ...
						   var newvalue = ed.getContent()
														 .replace(/\r?\n/gm, '' )
														 .replace(/\.\.\/wp-content\/uploads\//g, uix_slideshow_custom_metaboxes_lang.upload_dir_url );
						...
						ed.addButton('uix_slideshow_cmb_image', {
						...
						// Add link button
						ed.addButton('uix_slideshow_cmb_link', {
							icon: 'mce-ico mce-i-link',
							tooltip: uix_slideshow_custom_metaboxes_lang.ed_link_title,
							onclick: function (e) {
								...
								ed.windowManager.open( {
									title: uix_slideshow_custom_metaboxes_lang.ed_link_title,
									body: [
									{
										type: 'textbox',
										label: uix_slideshow_custom_metaboxes_lang.ed_link_field_url,
										name: 'link_url',
										value: curlinkURL,
										placeholder: 'https://',
										multiline: true,
									...
									{
										type: 'textbox',
										label: uix_slideshow_custom_metaboxes_lang.ed_link_field_text,
										name: 'link_text',
										value: curlabel,
										multiline: true,
										minWidth: 500,
										...
										
									{
										...
										name: 'link_target',
										label: ' ',
										text: ' ' + uix_slideshow_custom_metaboxes_lang.ed_link_field_win,
									},
						...
						//Delete link button
						ed.addButton('uix_slideshow_cmb_unlink', {
							icon: 'mce-ico mce-i-unlink',
							tooltip: uix_slideshow_custom_metaboxes_lang.ed_unlink_title,
							onclick: function (e) {
						...
						ed.addButton('uix_slideshow_cmb_highlightcode', {
							...
							tooltip: uix_slideshow_custom_metaboxes_lang.ed_hcode_title,
							onclick: function (e) {
								
								
								ed.windowManager.open( {
									title: uix_slideshow_custom_metaboxes_lang.ed_hcode_title,
									body: [
                                        {
                                            type   : 'listbox',
                                            name   : 'lang',
                                            label  : uix_slideshow_custom_metaboxes_lang.ed_hcode_field_label,
                                            values : [
                                                { value: 'xml', text: 'xml' },
                                                { value: 'css', text: 'css' },
				  ...
				  content_css: [
					uix_slideshow_custom_metaboxes_lang.ed_url + 'css/uix-custom-metaboxes-editor.css'
				  ]
				});	
			}
...
( function ( $ ) {
	'use strict';
    $.fn.UixSlideshowEditorInit = function( options ) {
        ...
        this.each( function() {
            ...
            if ( $this.attr( 'aria-init' ) == 0 ) {
                ...
                $( document ).UixSlideshowMCEEditor({
...
( function ( $ ) {
	'use strict';
    $.fn.UixSlideshowToggleSelectInit = function( options ) {
 
        // This is the easiest way to have default options.
        const settings = $.extend({
            wrapper           : '.uix-slideshow-cmb__text--div--toggle.uix-slideshow-cmb__text--div--toggle-customlevel',
            wrapperChild      : '.uix-slideshow-cmb__text--div--toggle--child',
            fieldSelect       : '.uix-slideshow-cmb__text--div--toggle__sel', 
            fieldId           : '.uix-slideshow-cmb__text--div--toggle__id',
            fieldTitle        : '.uix-slideshow-cmb__text--div--toggle__title',
            fieldDefaultValue : '.uix-slideshow-cmb__text--div--toggle__toggleSelect',
            trigger           : '.uix-slideshow-cmb__text--div--toggle__trigger'
        }, options );
			...
			*/
			...
			const updateAppearance = function( data, stylesAndOrderUpdate ) {
				...
				*/	
				...
				$listItemsContainer.find( 'textarea.uix-slideshow-cmb__custom-attributes-field__resultData' ).val( createPHPData(variableResDataSortAllReversed) );

				$listItemsContainer.find( 'textarea.uix-slideshow-cmb__custom-attributes-field__resultReverseData' ).val( createPHPData(variableResDataSortAll) );
			...
			const selectBuilder = function( data, parentID, removeID ) {
				let html_code = '<select class="uix-slideshow-cmb__text--fullwidth uix-slideshow-cmb__text--div--toggle__sel">';
				...
				$( settings.wrapper ).each( function()  {
					...
					for (let k = 0; k < hasParentIDsRes.length; k++) {
						if (hasParentIDsRes[k] === _cid ) {
							let _codeEmpty = '<select class="uix-slideshow-cmb__text--fullwidth uix-slideshow-cmb__text--div--toggle__sel">';
					...
					//
					$wrapper.find( '.uix-slideshow-cmb__text--div--toggle__toggleSelect__append' ).html( _code ).promise().done( function(){

						//init default value for select control
						$wrapper.find( '.uix-slideshow-cmb__text--div--toggle__toggleSelect__append > select' ).val( _pid );
			...
			//
			$( document ).off( 'change.UixSlideshowToggleSelect' ).on( 'change.UixSlideshowToggleSelect', settings.wrapper + ' .uix-slideshow-cmb__text--div--toggle__toggleSelect__append > select', function() {
			...
			//
			$( document ).off( 'change.UixInputTextarea' ).on( 'change.UixInputTextarea', settings.wrapper + ' .uix-slideshow-cmb__text--div--toggle__title, ' + settings.wrapper + ' .uix-slideshow-cmb__text--div--toggle__classname, ' + settings.wrapper + ' .uix-slideshow-cmb__text--div--toggle__textarea, ' + settings.wrapper + ' textarea[data-enter-value="true"]', function() {
...
( function ( $ ) {
	'use strict';
    $.fn.UixSlideshowToggleSimpleSelectInit = function( options ) {
 
        // This is the easiest way to have default options.
        const settings = $.extend({ 
            type              : 'file',
            wrapper           : '.uix-slideshow-cmb__text--div--toggle:not(.uix-slideshow-cmb__text--div--toggle-customlevel)',
            trigger           : '.uix-slideshow-cmb__text--div--toggle__trigger'
        }, options );
        ...
        this.each( function( index ) {
            ...
            switch( defaultVal ) {
                case 'file':
                $this.closest( settings.wrapper ).find( '.uix-slideshow-cmb__text--row[data-type="file"]' ).show();
                $this.closest( settings.wrapper ).find( '.uix-slideshow-cmb__text--row[data-type="html"]' ).hide();
                break;

                case 'html':
                $this.closest( settings.wrapper ).find( '.uix-slideshow-cmb__text--row[data-type="file"]' ).hide();
                $this.closest( settings.wrapper ).find( '.uix-slideshow-cmb__text--row[data-type="html"]' ).show();
                break;      
            }      
            ...
            $this.off( 'change.UixSlideshowToggleSimpleSelect' ).on( 'change.UixSlideshowToggleSimpleSelect', function() {
 ...
 *************************************
 */	
function UixSlideshowGUIDCreate() {
 ...
 *************************************
 */	
function UixSlideshowGetRealIds( targetID ) {
