 ...
 *************************************************
 */
var UixSlideshowCustomMetaboxes = function( obj ) {
	"use strict";


	var UixSlideshowCustomMetaboxesConstructor = function( obj ) {
		this.init = obj;
	};
	...
	UixSlideshowCustomMetaboxesConstructor.prototype = {
		...
		titleChange: function( wrapper, trigger, title ) {
			...
			jQuery( document ).ready( function() {
                jQuery( document ).off( 'input.UixSlideshowTitle change.UixSlideshowTitle' ).on( 'input.UixSlideshowTitle change.UixSlideshowTitle', title, function() {
		...
		toggleSelect: function() {
			...
			jQuery( document ).ready( function() {
                ...
                jQuery( '.uix-slideshow-cmb__wrapper.uix-slideshow-cmb__custom-attributes-field' ).UixSlideshowToggleSelectInit();
		...
		upload: function() {
			...
			jQuery( document ).ready( function() {
                ...
                var selector = '.uix-slideshow-cmb__upload-target';
				...
				jQuery( selector ).each( function()  {
					...
					if ( element != '' ) {
					 ...
					 //Delete image   
                    $this.next( _closebtn ).off( 'click.UixSlideshowUploadClose' ).on( 'click.UixSlideshowUploadClose', function( event ){
                    ...
                    //Prevent duplicate function assigned
                    $this.off( 'click.UixSlideshowUpload' ).on( 'click.UixSlideshowUpload', function( e ) {
                        e.preventDefault();
                    ...
                    });//endif click.UixSlideshowUpload
				...
				jQuery( selector ).each(function(){
					...
					$addButton.off( 'click.UixSlideshowCustomMetaboxes_customAttrs_add' ).on( 'click.UixSlideshowCustomMetaboxes_customAttrs_add', function( e ) {
						...
						if( x < maxField ){ 
                            ...
                            var uuid = UixSlideshowGUID.create();
                            ...
                            jQuery.when( jQuery( wrapperID ).length > 0 ).then( function() {
                                ...
                                UixSlideshowCustomMetaboxesInit.toggleSelect();
					...
					jQuery( document ).on( 'click.UixSlideshowCustomMetaboxes_customAttrs_remove', '.uix-slideshow-cmb__custom-attributes-field__removebtn', function( e ) {
                        ...
                        if ( confirm( uix_slideshow_custom_metaboxes_lang.delete_confirm_text ) ) {
                            var $li = jQuery( this ).closest( '.uix-slideshow-cmb__text--div' );
...
//--------
var UixSlideshowCustomMetaboxesInit = new UixSlideshowCustomMetaboxes();
            ...
            if( typeof id !== typeof undefined ) {
				...
				tinymce.init({
					...
					setup:function( ed ) {
                        ...
                        //Add media button
						function uix_slideshow_mce_insertImage() {
							var upload_frame;
							if( upload_frame ){
								upload_frame.open();
								return;
						...
						// Add link button
						ed.addButton('uix_slideshow_link', {
						...
						//Delete link button
						ed.addButton('uix_slideshow_unlink', {
						...
						ed.addButton('uix_slideshow_highlightcode', {
...
( function ( $ ) {
    ...
    $.fn.UixSlideshowToggleSelectInit = function( options ) {
        ...
        // This is the easiest way to have default options.
        var settings = $.extend({
            wrapper           : '.uix-slideshow-cmb__text--div--toggle',
        ...
        this.each( function() {
            ...
            $( this ).find( settings.wrapper ).each( function()  {
                ...
                //push options
                var options = '<option value="">'+uix_slideshow_custom_metaboxes_lang.select_empty_text+'</option>';
                ...
                $sel.html( options ).promise().done( function(){
                    ...
                    $sel.off( 'change.UixSlideshowToggleSelect' ).on( 'change.UixSlideshowToggleSelect', function() {
 ...
 *************************************
 */	
var UixSlideshowGUID = UixSlideshowGUID || ( () => {
    function t() {
        do {
